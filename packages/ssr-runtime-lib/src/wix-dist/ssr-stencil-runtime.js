...
const createElm = (e, t, o, n) => {
 ...
 a && (n[s].$elm$ = a, r.insertBefore(a,  t)));
}, removeVnodes = (e, t, o, n, s) => {
 for (;t <= o; ++t) (n = e[t]) && (s = n.$elm$, s.remove());
 ...
 const o = t.$elm$ = e.$elm$, n = e.$children$, s = t.$children$;
  ...
  $ = t[++a], h = n[++r]; else if (isSameVnode(m, u)) patch(m, u), m = t[--c], u = n[--p]; else if (isSameVnode($, u)) patch($, u), e.insertBefore($.$elm$, m.$elm$.nextSibling), $ = t[++a], u = n[--p]; else if (isSameVnode(m, h)) patch(m, h), e.insertBefore(m.$elm$, $.$elm$), m = t[--c], h = n[++r]; else {
...
class InternalHookComponent {
    ...
    static get cmpMeta() { return {
        "$flags$": 0,
        "$tagName$": "wix-internal-hook-component",
        "$members$": undefined,
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": []
...
registerComponents([
  InternalHookComponent,...__stencil__.fetchRegisteredComponents(),
]);
